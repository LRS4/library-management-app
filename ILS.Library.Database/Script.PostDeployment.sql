...
INSERT INTO 
[Branch].[BranchDetails]([Address], [Name], Telephone, OpenDate, [Description]) 
VALUES 
...
SELECT * FROM [Branch].[BranchDetails]
...
('2017-06-23', 0.00),
('2017-06-23', 8.00);
SELECT * FROM [Branch].[LibraryCard]
